...
> 感谢 [@pirate-608](https://github.com/pirate-608) 贡献了 Electron 桌面应用打包支持！首次发布版本：[v2.0.0](https://github.com/pirate-608/exam-porridge-assistant/releases/tag/v2.0.0)
...
推送版本标签即可自动触发三平台构建并发布到 GitHub Releases：
...
推送后 GitHub Actions 会同时构建 Windows / macOS / Linux 安装包，自动发布到仓库的 **Releases** 页面。也可以在 Actions 页面手动触发（`workflow_dispatch`）。
...
感谢 [@pirate-608](https://github.com/pirate-608) 贡献 Electron 桌面应用打包与三平台自动发布工作流，让考试粥助手可以生成 Windows / macOS / Linux 安装包。
