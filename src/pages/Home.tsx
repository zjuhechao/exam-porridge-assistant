        ...
        <div className="max-w-4xl mx-auto text-center relative">
          ...
          >
            ...
            <div className="flex flex-wrap justify-center gap-4">
              <Link
                to="/knowledge"
                className="inline-flex items-center gap-2 px-6 py-3 rounded-xl bg-gradient-to-r from-cyan-500 to-purple-600 text-white font-medium hover:opacity-90 transition-opacity"
              >
                开始使用
              ...
              <Link
                to="/settings"
                className="inline-flex items-center gap-2 px-6 py-3 rounded-xl bg-slate-800 text-slate-200 font-medium hover:bg-slate-700 transition-colors"
              >
                配置 API
              </Link>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {features.map((feature, index) => (
              ...
              >
                <Link
                  to={feature.path}
                  className="group block p-6 rounded-2xl bg-slate-900/50 border border-slate-800 hover:border-slate-700 transition-all duration-300 hover:shadow-lg hover:shadow-cyan-500/10"
                >
                  <div className="flex items-start gap-4">
                    ...
                    <ArrowRight
                      className="w-5 h-5 text-slate-600 group-hover:text-cyan-400 transition-colors flex-shrink-0"
                    />
                  </div>
                </Link>
              </motion.div>
